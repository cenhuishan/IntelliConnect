const { getProductLlmModel, postProductLlmModel, deleteProductLlmModel } = require('../../api/productLlmModel')
...
Page({
  ...
  onSubmit() {
    postProductLlmModel(this.data.form)
      .then((res) => {
