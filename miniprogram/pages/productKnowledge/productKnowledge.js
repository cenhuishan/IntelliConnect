const { getProductKnowledge, postProductKnowledge, deleteProductKnowledge } = require('../../api/productKnowledge')
...
Page({
  ...
  onSubmit() {
    postProductKnowledge(this.data.form)
      .then((res) => {
