const { getProductEventData, postProductEventData, deleteProductEventData } = require('../../api/productEventData')
...
Page({
  ...
  onSubmit() {
    postProductEventData(this.data.form)
      .then((res) => {
