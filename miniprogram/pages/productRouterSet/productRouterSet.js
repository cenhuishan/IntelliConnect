const { getProductRouterSet, postProductRouterSet, deleteProductRouterSet } = require('../../api/productRouterSet')
...
Page({
  ...
  onSubmit() {
    postProductRouterSet(this.data.form)
      .then((res) => {
