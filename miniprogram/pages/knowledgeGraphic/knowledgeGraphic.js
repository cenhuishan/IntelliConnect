const { getKnowledgeGraphic, postKnowledgeGraphic, deleteKnowledgeGraphic } = require('../../api/knowledgeGraphic')
...
Page({
  ...
  onSubmit() {
    postKnowledgeGraphic(this.data.form)
      .then((res) => {
