const { getAgentLongMemory, postAgentLongMemory, deleteAgentLongMemory } = require('../../api/agentLongMemory')
...
Page({
  ...
  onSubmit() {
    postAgentLongMemory(this.data.form)
      .then((res) => {
